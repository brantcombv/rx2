...
class Rx_Router_Route_Regex extends Rx_Router_Route_Base
{
    ...
    public function assemble($data = array(), $reset = false, $encode = false, $partial = false)
    {
        if ($this->_reverse === null) {
            throw new Rx_Exception('Cannot assemble. Reversed route is not specified.');
        }
        ...
        if ($return === false) {
            throw new Rx_Exception('Cannot assemble. Too few arguments?');
        }


        return ($this->_assemble($return));
    }
